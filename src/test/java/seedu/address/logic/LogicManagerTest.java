...
public class LogicManagerTest {
    ...
    public void setUp() {
        JsonTaskListStorage taskListStorage =
                new JsonTaskListStorage(temporaryFolder.resolve("harmonia.json"));
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        ...
        assertCommandException(deleteCommand, "Index 9: " + MESSAGE_INVALID_TASK_DISPLAYED_INDEX + "\n");
    }

    @Test
    public void execute_validCommand_success() throws Exception {
        String listCommand = ListCommand.COMMAND_WORD;
        assertCommandSuccess(listCommand, ListCommand.LIST_TASKS_MESSAGE_SUCCESS, model);
    }
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_TUTORIAL + DESCRIPTION_DESC_TUTORIAL
                + DEADLINE_DESC_TUTORIAL + PRIORITY_LOW;
        Task expectedTask = new TaskBuilder(CS2103T_TUTORIAL).withCompletionStatus("false").withTags().build();
